...
<div id="main" class="indiv">
  ...
  <div id="right_column">
    ...
    <div id="intro">
      <p>
      This long-selling product has evolved over the past ten years or so from the original Model 5000 into this, the current Model 5000 Signature. This no-digital filter/no-oversampling multi bit type D/A converter is based on US-patented analog filter technology. It incorporates a multi-bit type Philips TDA-1541A double crown DAC-IC, and the reality of its reproduced sound continues to allure and amaze us even now. Even the very latest DAC-ICs cannot compare to this.
      </p>
    </div>

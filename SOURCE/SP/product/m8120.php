			...
			<div id="product_image">
				<div class="carousel">
					<div class="product-image-wrapper">
						<div class="thumbs-image"><img src="<?php echo PATH_TO_ROOT ?>images/products/thumb-m8120a.png" alt=""></div>
					</div>
					<div class="product-image-wrapper">
						<div class="thumbs-image"><img src="<?php echo PATH_TO_ROOT ?>images/products/thumb-m8120b.png" alt=""></div>
					</div>
				</div>
			</div>
				...
				<article>
					...
					<dl>
				        ...
				        <dt>Input impedance</dt>
					        ...
					        <dd>7kΩ (XLR-optional)</dd>
				        <dt>Output impedance</dt>
					        <dd>4&Omega; / 8&Omega;</dd>
				        <dt>Analog input</dt>
					        <dd>RCA and XLR (optional)</dd>
				        <dt>Frequency response</dt>
					        <dd>7Hz-60kHz (-1db)</dd>
				        <dt>Tube complement</dt>
					        <dd>KT-120 x4</dd>
					        <dd>12AU7 x4</dd>
				        <dt>Trigger input/output</dt>
					        <dd>3.5mm stereo mini-phone jacks</dd>

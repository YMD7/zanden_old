...
<div class="company-front">
  ...
  <h2>Company</h2>
    <div class="text">
    <h3>Introduction</h3>
    <p>Established in 1980, Zanden Audio Systems mainly produces and sells audio products that utilize vacuum tubes.</p>
    <p>
    At Zanden Audio Systems, we embrace two driving principles. The first is to reproduce and express music including space as faithfully as possible when it is played back. The second is to create beautiful products, as if they were musical instruments, that are both a joy to own and master and that can be handed down and used successively by future generations.</p>
    <p>
    The circuit technology that forms the foundation of Zanden audio products is completely innovative. It has been patented from original ideas born from intensive review of existing amplifier circuits.</p>
    <p>
    All of the components in these products have been carefully and specially selected with tonal quality and ageing characteristics factored into the design.</p>
    <p>
    Each and every one of these products is painstakingly hand-crafted by artisans and finally adjusted after meticulous sensory evaluation by experts before being delivered to the customer.</p>
    <p>
...
I have felt this strange feeling of disconnection that arises from this gap. And, I have also seen it shared by many other listeners who love and enjoy music. This prompted me to realize that, as an audio engineer, I had a sacred mission to bridge this gap.</p>
    ...
    <p class="signature">
    <em>Owner &amp; Technical Director</em><br />
    <b>Kazutoshi Yamada</b>
    </p>
    </div>

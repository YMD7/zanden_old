$(function() {
	...
	var domain = has_www ? "http://www.zandenaudio.com/" : "http://zandenaudio.com/";
	...
	$('div#sub_navi dl a[href="http://www.zandenaudio.com/product/' + productNames[currentProduct] + '"] dd').addClass("current");

			...
			<div id="product_image">
				<div class="carousel">
					<div class="product-image-wrapper">
						<div class="thumbs-image"><img src="<?php echo PATH_TO_ROOT ?>images/products/thumb-m1200a.png" alt=""></div>
					</div>
					<div class="product-image-wrapper">
						<div class="thumbs-image"><img src="<?php echo PATH_TO_ROOT ?>images/products/thumb-m1200b.png" alt=""></div>
					</div>
					<div class="product-image-wrapper">a
						<div class="thumbs-image"><img src="<?php echo PATH_TO_ROOT ?>images/products/thumb-powerbox1a.png" alt=""></div>
					</div>
					<div class="product-image-wrapper">
						<div class="thumbs-image"><img src="<?php echo PATH_TO_ROOT ?>images/products/thumb-powerbox1b.png" alt=""></div>
					</div>
				</div>
			</div>
